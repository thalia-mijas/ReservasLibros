"use strict";
class User {
    constructor(nombre, email, nacimiento) {
        this.name = nombre;
        this.email = email;
    ...
    newUser() {
        const urlUser = document.getElementById("new-user-form")
            .action;
        if (urlUser) {
            const pathsUser = urlUser.split("=");
            ...
            if (userStorage) {
                ...
                usersList === null || usersList === void 0 ? void 0 : usersList.push(myObj);
